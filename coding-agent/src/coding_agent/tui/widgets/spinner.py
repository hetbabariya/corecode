"""Multi-state spinner widget — braille animation with stall detection and shimmer."""
...
class Spinner(Widget):
    ...
    def _tick(self) -> None:
        """Animation tick — handles frame advance, shimmer, and stall detection."""
        ...
        # Update stall intensity (0→1 over 3 seconds of no tokens)
